              ...
              <header className="text-center mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                  <div className="flex flex-col items-center justify-center rounded-xl border border-white/10 bg-black/40 p-4">
                    ...
                    <p className="text-white/70 text-sm">Fondation</p>
                    <p className="text-lg font-semibold text-white">2005</p>
                  </div>
                  <div className="flex flex-col items-center justify-center rounded-xl border border-white/10 bg-black/40 p-4">
                    <MapPin className="w-6 h-6 text-accent mb-2" />
                    <p className="text-white/70 text-sm">Localisation</p>
                    <p className="text-lg font-semibold text-white">Genève</p>
                  </div>
                  <div className="flex flex-col items-center justify-center rounded-xl border border-white/10 bg-black/40 p-4">
                    <Users className="w-6 h-6 text-accent mb-2" />
                    <p className="text-white/70 text-sm">Niveaux</p>
                    <p className="text-lg font-semibold text-white">Tous</p>
                  </div>
                </div>
              </header>
