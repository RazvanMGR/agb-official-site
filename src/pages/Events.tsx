  ...
  return (
    <div className="relative min-h-screen page-transition">
      ...
      <img
        ...
        aria-hidden
        draggable="false"
        className="fixed inset-0 z-0 w-full h-full object-cover object-center blur-sm brightness-[.82] saturate-75 pointer-events-none select-none [object-position:center_48%]"
      />
