...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const isHeroPage = ["/", "/about", "/events", "/results", "/committee"].includes(location.pathname);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      {/* CONTENT — pas de padding sur home/about/events, padding ailleurs */}
      <main className={isHeroPage ? "flex-1" : "pt-24 md:pt-28 flex-1"}>
        {children}
      </main>
